        ...
        didSet {
            switch self.type.rawValue {
                ...
                case 5:
                    ...
                    // placeholder 색상
                    guard let idholder = self.placeholder, !idholder.isEmpty else {return};
                    self.attributedPlaceholder = NSAttributedString(string: idholder, attributes: [.foregroundColor: UIColor.black])
                    //아래에만 밑줄
                    let lineColor = UIColor(red: 255/255, green: 0, blue: 0, alpha: 0);
                    let borderLine = UIView();
                    let height = 2.0;
                    self.borderStyle = UITextField.BorderStyle.none;
                    self.backgroundColor = UIColor.clear;
